...
sudo apt install xfce4-session xorg lightdm lightdm-gtk-greeter xfce4 policykit-1 xfce4-panel network-manager-gnome thunar xfce4-terminal pulseaudio xfce4-whiskermenu-plugin --no-install-recommends -y ;
